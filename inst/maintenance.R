...
regex_usa <- list(
    ...
    rm_between2 = "(?<=%s).*?(?=%s)",	
    rm_caps = "(\\b[A-Z]{2,}\\b)",
    rm_citation = "(((((([A-Z]{1}[a-zA-Z]+,\\s)*[A-Z]{1}[a-zA-Z]+\\s(\\&|and))\\s)*([A-Z]\\.\\s)*[A-Z]{1}[a-zA-Z]+\\s(et\\sal\\.\\s){0,1})|(\\s{0,1}[A-Z][A-Za-z]*\\s)+)\\(\\d{4}\\))|((([(]((([A-Z]{1}[a-zA-Z]+,\\s)*[A-Z]{1}[a-zA-Z]+\\s(\\&|and))\\s)*([A-Z]\\.\\s)*[A-Z]{1}[a-zA-Z]+\\s{0,1}(et\\sal\\.){0,1})|(\\s{0,1}[A-Z][A-Za-z]*\\s)+),\\s\\d{4}\\))",
    rm_citation2 = "((((([A-Z]{1}[a-zA-Z]+,\\s)*[A-Z]{1}[a-zA-Z]+\\s(\\&|and))\\s)*([A-Z]\\.\\s)*[A-Z]{1}[a-zA-Z]+\\s(et\\sal\\.\\s){0,1})|(\\s{0,1}[A-Z][A-Za-z]*\\s)+)\\(\\d{4}\\)",
    rm_citation3 = "(([(]((([A-Z]{1}[a-zA-Z]+,\\s)*[A-Z]{1}[a-zA-Z]+\\s(\\&|and))\\s)*([A-Z]\\.\\s)*[A-Z]{1}[a-zA-Z]+\\s{0,1}(et\\sal\\.){0,1})|(\\s{0,1}[A-Z][A-Za-z]*\\s)+),\\s\\d{4}\\)",
