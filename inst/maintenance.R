...
regex_usa <- list(
    ...
    rm_citation = paste0("(((((((\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+,\\s)*(\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+,*\\s(\\&|and))\\s)*([A-Z]\\.\\s)*(\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+\\s(et\\sal\\.\\s){0,1})|((\\b(v[oa]n|d[eua])\\s)*[A-Z][A-Za-z'-]*\\s)+)\\((((\\d{4}[a-z]{0,1})|(n\\.d\\.)|(in press))(,\\s*)*)+\\))",
        "|(((?<=(\\(|(;\\s))|(\\(((e\\.g\\.)|(cf\\.)|(viz\\.)),{0,1}\\s))((((\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+,\\s)*(\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+,*\\s(\\&|and))\\s)*([A-Z]\\.\\s)*(\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+\\s{0,1}(et\\sal\\.){0,1})|((\\b(v[oa]n|d[eua])\\s)*[A-Z][A-Za-z'-]*\\s)+),\\s(((\\d{4}[a-z]{0,1})|(n\\.d\\.)|(in press))(,*\\s*)*)+(?<=[)]{0,1})"),
    ...
    rm_citation3 = "(((?<=(\\(|(;\\s))|(\\(((e\\.g\\.)|(cf\\.)|(viz\\.)),{0,1}\\s))((((\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+,\\s)*(\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+,*\\s(\\&|and))\\s)*([A-Z]\\.\\s)*(\\b(v[oa]n|d[eua])\\s)*[A-Z]{1}[a-zA-Z-]+\\s{0,1}(et\\sal\\.){0,1})|((\\b(v[oa]n|d[eua])\\s)*[A-Z][A-Za-z'-]*\\s)+),\\s(((\\d{4}[a-z]{0,1})|(n\\.d\\.)|(in press))(,*\\s*)*)+(?<=[)]{0,1})",
