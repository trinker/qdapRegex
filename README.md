...
The **qdapRegex** package does not aim to compete with string manipulation packages such as **stringr** or **stringi** but is meant to provide access to canned, common regular expression patterns that can be used within **qdapRegex**, with **R**'s on regular expression functions, or add on string manipulation packages.
